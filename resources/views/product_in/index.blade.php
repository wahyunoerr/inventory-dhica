...
@section('halaman', 'Produk Masuk')
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Data Produk Masuk</h3>
            <a href="{{ route('produkIn.create') }}" class="btn btn-sm btn-primary float-right"><i class="fas fa-plus"></i></a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('produkIn.delete', $item->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
